...
class _DriveScreenState extends State<DriveScreen>
  ...
  int _warning = 0; // Warning value from the server
  ...
  void _connectToSocket() {
    ...
    // Listen for the 'update_warning' event
    socket.on('update_warning', (data) {
      setState(() {
        _warning = data['warning'];
        _showWarning = _warning != 0; // Show warning if _warning is not 0
      });
    });
          ...
          if (_warning == 1)
            Positioned(
              ...
              child: _buildWarningBox(
                ...
                headerColor: Color(0xFFFFF9CC), // Pastel Yellow
                hasDismissButton: false,
              ),
            ),
          if (_warning == 2)
            Positioned(
              ...
              child: _buildWarningBox(
                ...
                description:
                    "A loud alarm will play periodically until dismissed.",
                headerColor: Color(0xFFFFE4E4), // Pastel Red
                hasDismissButton: true,
              ),
            ),
        ],
